...
// FIX: Extend RechartsPrimitive.Tooltip with manual overrides for common missing props (payload, label, active)
// We retain the generic TooltipProps type for completeness but ensure the properties are available via the spread operator.
const ChartTooltipContent = React.forwardRef<
  HTMLDivElement,
  TooltipProps<any, any> &
    React.ComponentProps<'div'> & {
      payload?: { dataKey: string; name?: string; value: any; color?: string; fill?: string; payload: any }[]; // Explicitly add payload
      label?: any; // Explicitly add label
      active?: boolean; // Explicitly add active
      hideLabel?: boolean;
...
>(
  (
    ...
    const tooltipLabel = React.useMemo(() => {
      // FIX: Ensure payload is checked before accessing length
    ...
    // FIX: Ensure active and payload are checked
